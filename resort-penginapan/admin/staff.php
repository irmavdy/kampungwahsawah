...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Nama :</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">Jabatan :</label>
            <select name="staffwork" class="form-control">
                <option value selected></option>
                <option value="Manager">Manager</option>
                <option value="Cook">Pemasak</option>
                <option value="Helper">Helper</option>
                <option value="cleaner">cleaner</option>
                <option value="weighter">weighter</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">Masukan Staf</button>
        </form>
